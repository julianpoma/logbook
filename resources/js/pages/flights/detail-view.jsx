...
function Form({ flight, aircrafts }) {
  ...
  const {
    ...
    time_total: flight?.time_total ? +flight.time_total : '',
    time_pic: flight?.time_pic ? +flight.time_pic : '',
    time_sic: flight?.time_sic ? +flight.time_sic : '',
    time_xc: flight?.time_xc ? +flight.time_xc : '',
    time_night: flight?.time_night ? +flight.time_night : '',
    time_solo: flight?.time_solo ? +flight.time_solo : '',
    time_dual_received: flight?.time_dual_received ? +flight.time_dual_received : '',
    time_actual_instrument: flight?.time_actual_instrument ? +flight.time_actual_instrument : '',
    time_simulated_instrument: flight?.time_simulated_instrument ? +flight.time_simulated_instrument : '',
    landings_day: flight?.landings_day ? +flight.landings_day : '',
    landings_night: flight?.landings_night ? +flight.landings_night : '',
  ...
  const handleSubmit = useCallback(
    (event) => {
      ...
      if (mode === 'create') {
        ...
        put(route('flights.update', flight.id), {
...
export default function DetailView({ flights, aircrafts }) {
